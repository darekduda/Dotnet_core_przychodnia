...
{
    public class NowaUslugaKontrahentViewModel: JedenViewModel<UslugaKontrahent>
    {
        public NowaUslugaKontrahentViewModel()
         : base()
        {
            // tu okreslamy nazwe zakladki
            base.DisplayName = "Usługa kontrahenta";
            item = new UslugaKontrahent();
        }
        public int IDUslugi
        {
            get
        ...
        public override void Save()
        {
            ...
            gabinetEntities.UslugaKontrahent.Add(item);
